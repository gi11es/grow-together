...
echo UIHelper::RenderMenu($PAGE_CODE['CODE_SAMPLES'], $userid);
...
?>
<br />
Here are some code samples for the growth API. Feel free to <a href="http://www.facebook.com/inbox/?compose&id=500347728">send me new ones</a>.
<br />
<br />
<div id="codesample">
  <?php include 'codesamplecontrol.php'; ?>
</div>
