...
class growtogether {
	...
	public static $growthid="18c2d9d8ee469a4ee8d6132ceb8d519fee09f30a"; 
	...
	*/
	function getTextAds($type="full", $count=1) {
		...
		$result = "<div class='growtogether_$type'>";
...
Displaying some ads:<br/>
<br/>
<?php echo growtogether::getAds(2); ?>
